  ...
  return (
    <div className="fixed top-[30%] sm:left-6 left-3">
      <ul className="flex flex-col gap-4 lg:gap-10">
        <li className="relative text-xl sm:text-2xl md:text-4xl lg:text-5xl  bg-green text-white p-3 rounded-full hover:scale-125 duration-300 cursor-pointer group">
