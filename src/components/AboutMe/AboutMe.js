    ...
    >
      <div className="w-2/3 sm:w-3/5 lg:w-9/12 mt-10 flex flex-col justify-center">
        ...
        <div className="grid sm:ml-3 md:gap-2 mt-6 md:pt-3 ">
          ...
          <div className="relative animate-bounce bg-slate-900 rounded border h-10 w-2/5 sm:w-28 ml-3 lg:ml-20">
            <span className="flex  justify-center mt-1 text-white text-xl sm:text-2xl">
              hello.
            </span>
            <div className="left-[39px] absolute bg-slate-900 bottom-0 transform -translate-x-1/2 translate-y-1/2 rotate-45 w-5 h-5  border-r border-b border-yellow-500"></div>
          </div>

          <div className="px-2  pt-6 lg:px-6 lg:pt-8 pb-8 text-slate-600">
...
<div block>
            <p className="font-light dark:text-white mt-8 text-lg lg:px-14 lg:text-xl lg:mt-4">
              I specialize in creating <span className="text-xl text-yellow">beautiful, usable, and  professional </span> 
            ...
            <p className="font-light dark:text-white text-lg mt-4 lg:text-xl lg:px-14">
              Today, I'm proficient in <span className="text-semibold text-yellow">HTML, CSS, JavaScript, React, and
