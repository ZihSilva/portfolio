...
function Skills() {
    return (
        <div>
            ...
            <div
                // name="skills"
                className="bg-white dark:bg-slate-900 pb-4 dark:text-white w-full flex justify-center  font-myfont"
            >
                <div className="w-full md:w-10/12 xl:w-full  flex-col lg:mr-20 md:flex-wrap">
                    ...
                    <ul className="grid grid-cols-2 w-50% mt-8 pr-5 sm:grid-cols-4 md:grid-cols-6 md:pr-0 lg:w-max lg:pr-0 xl">
                        ...
                        <li className="flex-wrap space-around w-full text-center m-3 flex-col flex justify-center  text-stone-500 text-md">
                        <img className="h-10 flex justify-center self-center" src="https://www.svgrepo.com/show/473768/react.svg" alt="React" />
                            <p className="flex justify-center items-center mt-2">React</p>
                        </li>

                        <li className="flex-wrap space-around w-full text-center m-3 flex-col flex justify-center  text-stone-500 text-md">
                        <img className="h-10 flex justify-center self-center" src="https://seeklogo.com/images/G/github-logo-7880D80B8D-seeklogo.com.png" alt="Github" />
                            <p className="flex justify-center items-center mt-2">Github</p>
                        </li>

                        <li className="flex-wrap space-around w-full text-center m-3 flex-col flex justify-center  text-stone-500 text-md">
                        <img className="h-10 flex justify-center self-center" src="https://www.svgrepo.com/show/503445/nodejs.svg" alt="NodeJs" />  
                    <p className="flex justify-center items-center mt-2">NodeJs</p>
                        ...
                        <li className="flex-wrap space-around w-full text-center m-3 flex-col flex justify-center  text-stone-500 text-md">
                        <img className="h-10 flex justify-center self-center" src="https://www.svgrepo.com/show/353724/express.svg" alt="react" />
                        <p className="flex justify-center items-center mt-2">Express</p>
                        </li>

                        <li className="flex-wrap space-around w-full text-center m-3 flex-col flex justify-center  text-stone-500 text-md">
                            <img className="h-10 flex justify-center self-center" src="https://www.svgrepo.com/show/333609/tailwind-css.svg" alt="tailwind" />
                        ...
                        <li className="flex-wrap space-around w-full text-center m-3 flex-col flex justify-center  text-stone-500 text-md">
                            <img className="h-10 flex justify-center self-center" src="https://logodownload.org/wp-content/uploads/2022/12/figma-logo-0.png" alt="Figma" />
