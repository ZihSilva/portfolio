...
function Skills() {
    return (
        <div>
            ...
            >
                <div className="w-2/3 md:w-9/12  lg:w-9/12 lg:gap-x-10 px-2 flex flex-col md:flex-wrap justify-center">
                    ...
                    <li className="flex-wrap transform-gpu flex-col flex justify-center  text-stone-500 text-md  bg-blue-50 p-3 rounded-20 hover:scale-125 duration-300 rounded-xl shadow-lg shadow-indigo-500/40">
                        ...
                        <li className="flex-wrap transform-gpu flex-col flex justify-center  text-stone-500 text-md  bg-blue-50 p-3 rounded-20 hover:scale-125 duration-300 rounded-xl shadow-lg shadow-indigo-500/40">
                            ...
                            <img className="h-20 w-50 contain flex justify-center self-center" src="https://www.svgrepo.com/show/452185/css-3.svg" alt="CSS3" />
                        </li>

                        <li className="flex-wrap transform-gpu flex-col flex justify-center  text-stone-500 text-md  bg-blue-50 p-3 rounded-20 hover:scale-125 duration-300 rounded-xl shadow-lg shadow-indigo-500/40">
                            <p className="flex justify-center items-center">Javascript</p>
                            <img className="h-20 w-50 flex contain  justify-center self-center" src="https://www.svgrepo.com/show/349419/javascript.svg" alt="javascript" />
                        </li>
                        ...
                        <li className="flex-wrap transform-gpu flex-col flex justify-center  text-stone-500 text-md  bg-blue-50 p-3 rounded-20 hover:scale-125 duration-300 rounded-xl shadow-lg shadow-indigo-500/40">
                            ...
                            <img className="h-20 w-50 contain  flex justify-center self-center" src="https://www.svgrepo.com/show/353724/express.svg" alt="react" />
                        </li>

                        <li className="flex-wrap transform-gpu flex-col flex justify-center  text-stone-500 text-md  bg-blue-50 p-3 rounded-20 hover:scale-125 duration-300 rounded-xl shadow-lg shadow-indigo-500/40">
                            <p className="flex justify-center items-center">Tailwind</p>
                            <img className="h-20 w-50 contain  flex justify-center self-center" src="https://www.svgrepo.com/show/333609/tailwind-css.svg" alt="tailwind" />
                        </li>

                        <li className="flex-wrap transform-gpu flex-col flex justify-center  text-stone-500 text-md  bg-blue-50 p-3 rounded-20 hover:scale-125 duration-300 rounded-xl shadow-lg shadow-indigo-500/40">
                            <p className="flex justify-center items-center">JSON</p>
                            <img className="h-20 w-50 contain  flex justify-center self-center" src="https://seeklogo.com/images/J/json-logo-265700B506-seeklogo.com.jpg" alt="json" />
                        </li>
