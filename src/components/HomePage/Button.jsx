...
function Button() {
    return (
        <Link to="contact" smooth={true} duration={500} className="relative px-6 py-3 font-bold ml-2 mb-10 xs:px-3 xs:py-2 md:px-4 md:py-3 md:mt-4 lg:px-10 lg:py-6 mt-2 text-slate-900 group">
