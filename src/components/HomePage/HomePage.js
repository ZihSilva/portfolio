...
export function HomePage() {
  return (
    ...
    >
      <div className="w-2/3 mx-auto mr-8 flex  justify-center items-center flex-row md:w-full h-full">
        <div className="sm:flex ml-2 gap-2 items-center">
          ...
          <div className="mt-8 pr-12 sm:pl-6 sm:pt-8 md:pl-4">
            <p className="text-white mr-8 text-xl sm:text-xl mb-1">My Name is</p>
            ...
            <button
              className="py-1 px-6 mr-6 mb-10 mt-2 border-2 border-indigo-700 bg-indigo-700 rounded-lg text-white font-bold uppercase hover:bg-transparent hover:text-indigo-700 duration-300">
             Hire Me
            </button>
            </Link>
          </div>
