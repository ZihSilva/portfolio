      ...
      <div className="w-2/3 sm:w-4/5 lg:w-9/12 mx-auto flex justify-center items-center flex-row md:mt-6">
        <div className="sm:flex gap-2 items-center ">
          ...
          <div className="mt-8 mx-auto text-center sm:pl-4 sm:mt-20 md:mb-10 md:pl-4 lg:ml-10">
            <p className="text-stone-500 dark:text-white text-md sm:text-xl sm:mt-10 md:text-lg md:mt-0 mb-1 lg:text-xl bold font-base">Hello, I'm</p>
            <h5 className="text-yellow mt-2 ml-3 text-3xl sm:text-3xl md:text-4xl lg:text-6xl mb-1 font-bold">
              Zimarlen 
            </h5>
            <p className="text-stone-500 dark:text-white font-light text-md sm:text-xl sm:mt-10 md:text-lg md:mt-0 mb-1 lg:text-xl">
