...
const Project = () => {
  return (
    <section name="project" className="bg-blue-100 dark:bg-slate-900 dark:text-white max-h-full py-6 px-3 w-full flex-col flex items-center font-myfont justify-center">
    <div className="w-2/3 mx-auto h-full flex flex-col justify-center">
      <div className="text-center md:text-center font-bold">
        <h1 className="text-stone-500 mb-6 text-2xl sm:text-3xl md:text-4xl lg:text-6xl border-b-4 border-yellow-300 inline">
            Projects
          </h1>
          <p className="my-8 mx-2 text-stone-500">
            ...
            <a
              className="ml-2 py-1 font-bold tracking-wider border-yellow-300 border-b-2 hover:border-yellow-300 dark:hover:border-yellow-600 transition ease-in duration-300"
              ...
              <div key={project.id} className="w-auto">
                ...
                <h3 className="text-xl max-auto lg:text-2xl  tracking-wide font-semibold py-2 text-stone-600">
                  ...
                  <a
                    ...
                    rel="noreferrer noopener"
                    title="Live Site"
                    className="ml-2 font-normal text-md border-yellow-300 border-b-2 hover:text-yellow-600 transition cursor-pointer ease-in duration-300"
                  >
                    Live Site
                  </a>
                </h3>
